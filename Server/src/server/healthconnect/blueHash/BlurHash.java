 ...
 */
package server.healthconnect.blueHash;

import java.awt.image.BufferedImage;

/**
 *
 * This code is from https://github.com/lwolvej/blurhash4j
 */
public class BlurHash {
    ...
    public static String encode(BufferedImage bufferedImage) {
        return encode(bufferedImage, 4, 3);   // check the effect of difference parameters with https://blurha.sh/
    }
