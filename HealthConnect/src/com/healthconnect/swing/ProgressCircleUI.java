...
class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/healthconnect/icon/down.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/healthconnect/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/healthconnect/icon/file.png")).getImage();
    }
    ...
    if(pro.getProgressType() != Progress.ProgressType.NONE){
        g2.drawImage(pro.getProgressType() == Progress.ProgressType.CANCEL ? imageCancel:pro.getProgressType() == Progress.ProgressType.DOWN_FILE ? imageDown : imageFile, 
