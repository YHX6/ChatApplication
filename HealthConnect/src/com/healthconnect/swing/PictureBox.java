 ...
 *
 * @author xyh10
 * This class is used to hold a piacture
 */
public class PictureBox extends JLayeredPane{
    ...
    private Rectangle getAutoSize(Icon image) {
        ...
        if(w >= iw) w = iw;  // solve the problem when the picture is too large to show the hole
        if(h >= ih) h = ih;
        ...
        int x = getWidth()/2 - (width/2);   // to make piacture in the center
